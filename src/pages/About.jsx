...
<section className="relative">
  <HeroBackdrop />
  <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 text-gray-900 dark:text-white">
    <p className="text-gray-600 dark:text-white/80 text-xs uppercase tracking-wider">
      About
    </p>
    <h1 className="mt-2 text-4xl md:text-5xl font-extrabold leading-tight drop-shadow dark:drop-shadow">
      The Alumni System for the IET Pune Community
    </h1>
    <p className="mt-4 text-gray-700 dark:text-white/90 max-w-3xl">
    ...
    <div className="mt-8 flex flex-wrap gap-3">
      <Link
        to="/register"
        className="inline-flex items-center justify-center rounded-xl bg-blue-700 text-white dark:bg-white dark:text-blue-700 font-semibold px-5 py-3 hover:bg-blue-800 dark:hover:bg-blue-50 transition"
      >
        Join the community
      ...
      <Link
        to="/login"
        className="inline-flex items-center justify-center rounded-xl border border-gray-400 dark:border-white/40 text-gray-900 dark:text-white px-5 py-3 hover:bg-gray-100 dark:hover:bg-white/10 transition"
      >
        Sign in
      </Link>
    </div>
...
<section className="relative">
  <GradientBand />
  <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 text-center text-gray-900 dark:text-white">
    ...
    <div className="mt-6 flex gap-3 justify-center">
      <Link
        to="/register"
        className="rounded-xl bg-indigo-700 text-white dark:bg-white dark:text-indigo-700 font-semibold px-5 py-3 hover:bg-indigo-800 dark:hover:bg-violet-50 transition"
      >
        Join IETBRIDGE
      </Link>
      <Link
        to="/login"
        className="rounded-xl border border-gray-400 dark:border-white/40 text-gray-900 dark:text-white px-5 py-3 hover:bg-gray-100 dark:hover:bg-white/10 transition"
      >
        Sign In
      </Link>
    </div>
